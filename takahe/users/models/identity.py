...
class Identity(StatorModel):
    ...
    def fetch_actor(self) -> bool:
        ...
        # (Sutty advertises http/ipns/hyper alternates); prefer the HTML
        # permalink. Lemmy and some other implementations omit it entirely (the
        # actor id is the web profile), so fall back to actor_uri to keep the
        # profile link non-empty.
